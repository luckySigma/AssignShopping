...
/*	@Test
	public void testCRUDProduct() {
		...
		product.setDescription("This is a description about oppo obile phones");
	...
	public void testListActiveProductsByCategory() {
		...
		assertEquals("Something went wrong while fetching list of products",3,productDAO.listActiveProductsByCategory(3).size());
